...
// Countries most relevant to this camp's audience (Spain-based coach, Thailand
// venue, English-speaking international travelers) surfaced above the fold.
export const popularCountryCodes = ["ES", "GB", "US", "TH"];
